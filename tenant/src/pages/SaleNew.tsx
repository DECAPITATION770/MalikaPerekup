  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="text-body font-bold truncate">
...
export default function SaleNew() {
  ...
  const { data: devicesData, isLoading: devicesLoading } = useQuery({
    ...
    queryFn: () =>
      listDevices({ status: 'in_stock', q: debouncedSearch || undefined, limit: 20 }),
  ...
  return (
    <form
      ...
      className="flex flex-col gap-4 animate-fade-up pb-28 md:pb-6"
    >
          ...
          <Controller
            ...
            render={({ field }) => (
              <LabeledInput
                ...
                suffix={
                  <span className="text-hint text-text-muted font-medium">{watch('currency')}</span>
                }
                value={field.value ?? ''}
